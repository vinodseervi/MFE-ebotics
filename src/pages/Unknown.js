  ...
  const fetchChecks = useCallback(async (page = 0) => {
    ...
    try {
      ...
      const searchParams = {
        page: page,
        size: 50,
        unknown: true  // Always true for Unknown page
      };
      ...
      console.error('Error fetching unknown checks:', err);
      setError('Failed to load unknown checks. Please try again.');
    } finally {
      setLoading(false);
    }
  }, [selectedStatus, selectedPractice, advancedFilters, sortField, sortDirection, selectedMonth, selectedYear, searchTerm]);
    ...
    <div className="checks-page">
      <div className="page-header">
        <div className="page-header-content">
          <h1 className="page-title">Unknown</h1>
          <p className="page-subtitle">Manage and reconcile unknown payment checks</p>
        </div>
