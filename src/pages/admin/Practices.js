...
const Practices = () => {
  ...
  useEffect(() => {
    ...
    if (practiceCountryOpen && practiceCountryRef.current) {
      findScrollableContainers(practiceCountryRef.current).forEach(container => scrollableContainers.add(container));
    }
    if (editPracticeCountryOpen && editPracticeCountryRef.current) {
      findScrollableContainers(editPracticeCountryRef.current).forEach(container => scrollableContainers.add(container));
    }
    if (locationCountryOpen && locationCountryRef.current) {
      findScrollableContainers(locationCountryRef.current).forEach(container => scrollableContainers.add(container));
    }
    if (editLocationCountryOpen && editLocationCountryRef.current) {
      findScrollableContainers(editLocationCountryRef.current).forEach(container => scrollableContainers.add(container));
    }
